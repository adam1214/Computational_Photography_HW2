...
if __name__ == "__main__":
    ...
    image1 = cv2.imread('../my_deblur/blurred_image/curl_blurred.JPG')
    image2 = cv2.imread('../my_deblur/kernel/curl_kernel.JPG', cv2.IMREAD_GRAYSCALE)
    ...
    '''
    input_filename = 'my_image_curl.png'
    ...
    # store image
    imageio.imwrite('../my_deblur/my_deblur_curl.png', BRL_result)
